...
class Mail(object):
    ...
    def _Sender(self):
        ...
        """
        #return self.config.get("Sender") or self.config["Username"]    #old code
        return self.config.get("Sender") or self.config["From"]
...
def test():
    config = {
        "To": ["yinzhixin@iwaimai.baidu.com"],
        "Cc": [],
        "Bcc": [],
        'From': "super_tester",
        'Subject': "测试-D级上线",
        'Smtpserver': "mail2-in.baidu.com",
        'Username': "",
        'Password': ""
    }
    mail = Mail(config)
    ...
    <table cellpadding="2px" border="1">
        ...
        <tr>
            <td>上线功能描述</td>
            <td>这是一个很好很好 的功能这是一个很好很好 的功能这是一个很好很好 的功能这是一个很好很好 的功能</td>
        </tr>
        <tr>
            <td>是否自测</td>
            <td>是</td>
