...
(function($){
	...
	iziModal.prototype = {
		...
		init: function (element, options) {
            ...
            this.$overlay = $('<div class="'+PLUGIN_NAME+'-overlay" style="display:none;background-color:'+options.overlayColor+'"></div>');
            ...
            if (this.options.transitionOutModal !== '') {
                ...
                this.$element.one(animationEvent, function () {
                    ...
                    if( that.$element.hasClass(that.options.transitionOutModal) ){
						...
						// that.$overlay = that.$overlay.removeClass(that.options.transitionOutOverlay).detach();
                        that.$overlay.removeClass(that.options.transitionOutOverlay).hide();
