...
def create_engine(user=None, password=None, database=None, host='127.0.0.1', port=3306, **kw):
    if user is None and password is None and database is None:
        user = "28BA8DE8-AC0C"
        password = "452d-9E2C-B28D9F5485CF"
        database = "51talk_svc"
