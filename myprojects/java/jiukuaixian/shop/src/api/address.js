...
export default class address extends base {
  ...
  static page () {
    ...
    const url = `http://localhost:8080/customer/addresses`;
  ...
  static available (goodsList) {
    ...
    const url = `http://localhost:8080/customer/addresses/available`;
  ...
  static update (addrId, address) {
    ...
    const url = `http://localhost:8080/customer/addresses/${addrId}`;
    return this.post(url, address);
  }
  /**
   * 获取地址对象
  ...
  static setDefault (id) {
    ...
    const url = `http://localhost:8080/customer/addresses/${id}/default`;
    return this.get(url);
  }
  /**
   * 删除地址对象
